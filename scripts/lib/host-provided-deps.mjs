 ...
 *   pi ships these inside its own runtime (`@gsd/pi-coding-agent`'s
 ...
 *   `@gsd/pi-tui` cost 720ms of the 838ms git-install import, and
 ...
 *   specifiers `typebox` and `@gsd/pi-tui` for an extension, so
 ...
 *   copy. `@gsd/pi-coding-agent` is different: it is not resolvable
